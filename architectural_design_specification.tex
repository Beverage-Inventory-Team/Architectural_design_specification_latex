...
\newcommand{\authors}{Lokendra B. Chhetri \\ Bishal Paudel \\ Sima Raymajhi \\ Nirjal Phaiju \\ Kunal Samant}
...
\begin{figure}[h!]
	\centering
   	\includegraphics[width=0.60\textwidth]{images/logo_image}
\end{figure}
\vspace{0.5 in}
...
\begin{versionhistory}
  	\vhEntry{0.1}{08.03.2020}{LC}{document creation}
\end{versionhistory}
\newpage
